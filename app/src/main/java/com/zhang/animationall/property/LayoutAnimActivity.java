...
public class LayoutAnimActivity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChange = (CheckBox) findViewById(R.id.id_change);
        ...
        findViewById(R.id.addBtn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final Button button = new Button(LayoutAnimActivity.this);
                button.setText((++mVal) + "");
